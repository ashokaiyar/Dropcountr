...
My local utility uses the [Dropcountr platform](https://dropcountr.com) to connect to their smart water meters so users can track their water usage using the mobile Dropcountr app. 
